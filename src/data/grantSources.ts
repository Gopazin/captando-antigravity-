...
export const FONTES: GrantSource[] = [
  ...
  { id: 7, nome: "FINEP", url: "https://www.finep.gov.br", categoria: "Governo Federal", tipo: ["Inovação", "Pesquisa", "Tecnologia"], abrangencia: "Nacional", recurso: ["Subvenção Econômica", "Fundo Perdido", "Financiamento"], descricao: "Subvenção econômica e fundo perdido para inovação e P&D.", ativo: true },
